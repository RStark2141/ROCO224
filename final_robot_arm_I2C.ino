...
void homeMode() {
  ...
  moveSmooth(elbow1,       currentElbow1,  90);
  moveSmooth(elbow2,       currentElbow2,  90);
  moveSmooth(wrist1,       currentWrist1,  25);
  moveSmooth(wrist2,       currentWrist2,  30);
...
void swanMode() {
  ...
  moveSmooth(elbow1,       currentElbow1,  135);
  moveSmooth(elbow2,       currentElbow2,   45);
...
void collectMode() {
  ...
  moveSmooth(elbow1,       currentElbow1,   30);
  moveSmooth(elbow2,       currentElbow2,   45);
  moveSmooth(wrist1,       currentWrist1,   25);
...
void foodMode() {
  ...
  moveSmooth(elbow1,       currentElbow1,  currentElbow1);
  moveSmooth(elbow2,       currentElbow2,  currentElbow2);
}
...
void feedingMode() {
  ...
  moveSmooth(elbow1,       currentElbow1,  180);
  moveSmooth(elbow2,       currentElbow2,   35);
  moveSmooth(wrist1,       currentWrist1,   70);
  moveSmooth(wrist2,       currentWrist2,   90);
  moveSmooth(gripper,      currentGripper, 180);
}
...
void printAngles() {
  ...
  Serial.printf("Elbow1: %d°\n",     currentElbow1);
  Serial.printf("Elbow2: %d°\n",     currentElbow2);
...
void setup() {
  ...
  // automatically run the full sequence on startup
  runSequence();
}
...
void loop() {
  ...
  if (cmd.equalsIgnoreCase("get angles")) {
    ...
    if (sp < 0) {
      ...
      else if (m.equalsIgnoreCase("elbow1"))   moveSmooth(elbow1,       currentElbow1,  angle);
      else if (m.equalsIgnoreCase("elbow2"))   moveSmooth(elbow2,       currentElbow2,  angle);
